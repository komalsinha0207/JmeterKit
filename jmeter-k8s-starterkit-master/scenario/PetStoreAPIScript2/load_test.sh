...
jmeter -Ghost= -Gport= -Gprotocol= -Gthreads= -Gduration= -Grampup= --reportatendofloadtests --reportoutputfolder /report/report-PetStoreAPIScript2.jmx-2023-11-21_104355 --logfile /report/PetStoreAPIScript2.jmx_2023-11-21_104355.jtl --nongui --testfile PetStoreAPIScript2.jmx -Dserver.rmi.ssl.disable=true --remoteexit --remotestart 10.36.0.6 >> jmeter-master.out 2>> jmeter-master.err &
...
echo "Starting load test at : Tue Nov 21 10:43:55 UTC 2023" && wait
